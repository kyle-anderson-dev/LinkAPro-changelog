...
.header-style3.is-sticky .header-nav .nav > li > a {
    ...
    color: <?php echo (!empty($data['navigation-text-color-sticky'])) ? esc_html($data['navigation-text-color-sticky']): '#777777'; ?>;
...
.header-style5.overlay-bg-black .header-nav .nav > li > a { color: <?php echo (!empty($data['navigation-text-color'])) ? esc_html($data['navigation-text-color']): ''; ?>; }
...
.header-style5.is-sticky .header-nav .nav > li > a { color: <?php echo (!empty($data['navigation-text-color-sticky'])) ? esc_html($data['navigation-text-color-sticky']): '#777777'; ?>; }
...
.header-style7 .extra-nav .extra-cell a.btn { background-color: transparent; color: <?php echo (!empty($data['navigation-text-color'])) ? esc_html($data['navigation-text-color']): '#fff'; ?>; border: 2px solid <?php echo (!empty($data['navigation-text-color'])) ? esc_html($data['navigation-text-color']): '#fff'; ?>; margin-left: 5px; margin-right: 5px; padding: 4px 10px; }
...
.header-style7.is-sticky .header-nav .nav > li > a { color: <?php echo (!empty($data['navigation-text-color-sticky'])) ? esc_html($data['navigation-text-color-sticky']): '#777777'; ?>; }

.header-style7.is-sticky .extra-nav .extra-cell a.btn {  background-color: transparent;  color: <?php echo (!empty($data['navigation-text-color-sticky'])) ? esc_html($data['navigation-text-color-sticky']): '#777777'; ?>;  border: 2px solid <?php echo (!empty($data['navigation-text-color-sticky'])) ? esc_html($data['navigation-text-color-sticky']): '#777777'; ?>; }
...
.sf-header-inner .header-nav .nav > li.current-menu-item > a { color: <?php echo (!empty($data['inner-navigation-text-hover-color'])) ? esc_html($data['inner-navigation-text-hover-color']): ''; ?>; }

.sf-header-inner .header-nav .nav > li:hover > a { color: <?php echo (!empty($data['inner-navigation-text-hover-color'])) ? esc_html($data['inner-navigation-text-hover-color']).'!important': ''; ?>; }
...
.sf-footer-light .footer-top { background-color:#fafbfa; }

.sf-footer-light p { color:#777; }
...
.sf-footer-light .footer-bottom { background-color:#fafbfa; color:#777; position:relative;}

.sf-footer-light .sf-footer-divider-line { height:1px; background-color:#000; opacity:0.1;  }

.sf-footer-light  a, 

.sf-footer-light  a:visited { color:#777;}
...
.sf-featuerd-label { position:absolute; top:15px; left:-12px;  -moz-transform: rotate(-45deg);-webkit-transform: rotate(-45deg);-o-transform: rotate(-45deg);-ms-transform: rotate(-45deg); transform: rotate(-45deg); }
...
#pix-contact-info { font-size:13px; }


.jobqa-item-box { border:1px solid #e9e8e8; padding:20px 20px 30px;  border-radius:5px; -webkit-border-radius:5px; background-color:#fff;  }
.jobqa-question { margin-bottom:10px; font-weight:600; color:#222;}
.jobqa-question + .toggle.btn { min-width:80px !important; padding-top:7px; padding-bottom:7px;  }
#finishjobouter { padding-top:20px; text-align:center; }
#jobqa-main .owl-controls { margin-top:20px; }

#jobqa-notfount { border:1px solid #e9e8e8; padding:20px;  border-radius:5px; -webkit-border-radius:5px; text-align:center; }

.payforcontact { margin:30px 0px 20px; }
.jobavlcredits { display:inline-block; padding:3px 12px 2px; font-size:13px; font-weight:600; border:2px solid #222;  color:#222; border-radius:5px; -webkit-border-radius:5px; }

.jobavlcredits { -webkit-animation: wrench 4s ease infinite; animation: wrench 4s ease infinite; transform-origin-z: initial; }
/*========================*/
@-webkit-keyframes wrench {
0% { color:#222; border:2px solid #222; }
75% { color:#28a1d9;border:2px solid #28a1d9;  }
}
@keyframes wrench {
0% { color:222; border:2px solid #222; }
75% { color:#28a1d9; border:2px solid #28a1d9; }
...
.pix-jobclosed { margin-top:20px; display:inline-block; padding:3px 12px 2px; font-size:13px; font-weight:600; border:2px solid #f7554f;  color:#f7554f; border-radius:5px; -webkit-border-radius:5px; }

.pix-total-purchased,
.pix-total-purchased { margin-top: 30px; font-style: italic; font-size: 14px; color: #ef5e09; font-weight: 500; font-family: Montserrat;}
.pix-contact-info + .pix-total-purchased { margin-top:-30px; }




.job-search-wrap { padding:50px 0px; }
.job-search-wrap .job-search-container { width:100%; max-width:670px; margin:auto; }
.job-search-wrap .job-search-form {margin:0px; padding:0px; display:table; width:100%; max-width:1170px; margin:auto; }
.job-search-wrap .job-search-form .searchbars-left,
.job-search-wrap .job-search-form .searchbars-right { display:table-cell; vertical-align:middle; padding:0px; }

.job-search-form .searchbars-left .form-control,
.job-search-form .searchbars-left .sf-select-box > .dropdown-toggle { height:48px; border-radius:0px; -webkit-border-radius:0px; }

.job-search-form .searchbars-left .aon-search-category .form-control { padding-left:40px; }
.job-search-form .searchbars-left .bootstrap-select.sf-select-box  > .btn.dropdown-toggle { padding-left:40px; }

.job-search-form .searchbars-left .aon-search-category .form-control { border-radius:5px 0px 0px 5px; -webkit-border-radius:5px 0px 0px 5px;  }
.job-search-form .searchbars-left .aon-search-category .form-control:focus { border-color:#6ab33e; }

.job-search-form .searchbars-left .aon-search-city { width:200px; }
.job-search-form .searchbars-left .aon-search-city > .sf-select-box > .dropdown-toggle { width:100%; }
.job-search-form .searchbars-left .aon-search-city > .sf-select-box > .dropdown-toggle[aria-expanded="true"] { border-color:#6ab33e !important;}
.job-search-form .searchbars-left .aon-search-city > .sf-select-box > .dropdown-toggle[aria-expanded="true"] + .dropdown-menu { margin-top: 0px;}



.job-search-form .searchbars-right {width:120px; }
.job-search-form .searchbars-right .btn { height:48px; border-radius:0px 5px 5px 0px; -webkit-border-radius:0px 5px 5px 0px; }



.job-search-form-list { display:table; width:100%; margin:0px; padding:0px;  }
.job-search-form-list li { display:table-cell; vertical-align:middle; position:relative;  }
.job-search-form-list li .fa { position:absolute; top:0px; left:0px; width:40px; height:48px; line-height:48px; text-align:center; z-index:3; }


.category-autoload { position: absolute;  top: 15px;  right: 19px  !important; line-height:16px; display: none;  color: #e63f75; background-color: #fff;  z-index: 1; }
.category-autoload .fa { font-size:14px; width:auto !important; height:auto !important; line-height:normal !important;}
.ui-autocomplete-loading + .category-autoload { display:block; }
.aon-cat-clean { position: absolute; top: 16px; right: 16px; color: #FF2F34; cursor: pointer; font-size: 12px; display: none; }
.aon-cat-clean .fa {  width:auto !important; height:auto !important; line-height:normal !important;}

.ui-widget-content {  font-family:inherit; margin-top:-2px !important; border:1px solid #e9e9e9; border-radius:5px; -webkit-border-radius:5px; -webkit-box-shadow: 0 0 10px 5px rgba(0,0,0,0.5); box-shadow: 0 0 12px 3px rgba(0,0,0,0.1); -moz-transform: translateY(-20px); -webkit-transform: translateY(-20px); -o-transform: translateY(-20px); -ms-transform: translateY(-20px);
transform: translateY(-20px); }

.ui-widget-content .ui-menu-item-wrapper {color:#767676; padding:12px 15px; font-size:14px; background-color:#fff; font-weight:500;  }
.ui-widget-content .ui-state-active,
.ui-button.ui-state-active:hover {	border: 1px solid #ccc !important; color:#000 !important; background:#F2F2F2 !important; color:#000; z-index:1;}  


#pixjob-qaform { position:relative; width:100vw; left:50%; margin-left:-50vw; padding:150px 0px; background-color:#09F; background-size:cover; background-position:center; margin-top:-50px; position:relative; }
#pixjob-qaform:after { content:""; position:absolute; width:100%; height:100%; left:0; top:0px; background-color:#000; opacity:0.2; }
#pixjob-qaform > h4 { width:100%; max-width:1170px; margin:0px auto 50px; color:#fff; text-align:center; font-size:70px;  position:relative; z-index:1;}
#pixjob-qaform .job-search-form { width: 100%; max-width:600px; margin: auto; }

.wallet-topbx { float:right; }
.wallet-topbx li { padding:5px; }

.jobqa-item-box { border:none; }

#pixjob-qaform #finishjobouter { padding-top:50px; }