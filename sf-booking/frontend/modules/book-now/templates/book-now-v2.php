  ...
  <form class="book-now" method="post">
    ...
    <div class="form-nav">
      <ul class="nav nav-pills nav-justified steps">
        <li><a href="#step1" data-toggle="tab"><?php echo esc_html($step); $step++; ?>.
        ...
        <li><a href="#step2" data-toggle="tab"><?php echo esc_html($step); $step++; ?>.
        ...
        <?php } ?>  
        <li><a href="#step3" data-toggle="tab"><?php echo esc_html($step); $step++; ?>.
        ...
        <li><a href="#step4" data-toggle="tab"><?php echo esc_html($step); $step++; ?>.
