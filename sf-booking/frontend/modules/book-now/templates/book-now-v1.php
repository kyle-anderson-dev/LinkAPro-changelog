...
<form class="myform book-now" method="post">
  ...
  <div id="panel-1" class="padding-20 clearfix margin-b-30  bg-white sf-rouned-box">
    <div class="form-step-bx padding-lr-20">
      <h6><strong><?php echo esc_html($step); $step++; ?>.</strong>
      ...
      <div class="clearfix f-row">
		...
		if(service_finder_booking_date_method($author) == 'multidate'){
          ...
          <?php do_action('service_finder_multidate_services',$author,1); ?>
          </div>
          <?php }
		}else{
		if(!service_finder_is_job_author($jobid,$jobauthor) && !service_finder_is_quotation_author($quoteid,$quoteauthor)){ ?>
          <div id="bookingservices" style=" <?php echo ($settings['booking_basedon'] == 'block') ? 'display:none;' : ''; ?>">
          <?php do_action('service_finder_singledate_services',$author,1); ?>
          </div>
          <?php } 
		}  
		?>    
  ...
  <div id="panel-2" class="padding-20 clearfix margin-b-30  bg-white sf-rouned-box">
    <div class="form-step-bx padding-lr-20">
      <h6 class="mainheading"><strong><?php echo esc_html($step); $step++; ?>.</strong>
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <div class="input-group"> <span class="input-group-addon v-align-t"><i class="fa fa-pencil"></i></span>
              <textarea id="shortdesc" name="shortdesc" class="form-control sf-form-control" placeholder="<?php esc_html_e('Please insert short description of your task', 'service-finder'); ?>"><?php  
			   if(is_user_logged_in() && service_finder_getUserRole($current_user->ID) == 'Customer' && $jobid > 0 && $jobauthor == $current_user->ID) {
              ...
              <div class="form-group form-inline sf-card-group">
                ...
                <?php  
                  ...
                  <div class="radio sf-radio-checkbox">
                    ...
                    <label for="paymentviapayulatam"><?php echo '<img src="'.SERVICE_FINDER_BOOKING_IMAGE_URL.'/payment/payulatam.jpg" title="'.esc_html__('PayU Money','service-finder').'" alt="'.esc_html__('PayU Latam','service-finder').'">'; ?></label>
                  </div>
                  <?php } ?>
                  <?php  
				  if($pay_booking_amount_to == 'admin'){
