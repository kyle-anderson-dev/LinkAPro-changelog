...
$identityapprovedmsg = (!empty($service_finder_options['msg-identity-approved'])) ? esc_attr($service_finder_options['msg-identity-approved']) : esc_html__('Your profile is verified and this red badge will be published on your profile picture.', 'service-finder');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
			...
			if($identityapproved == 'unapproved')
			{
				...
				echo esc_html__('Your identity has been rejected by admin','servide-finder');
				echo '<br/>';
				echo '<strong>';
				echo esc_html__('Decline reason is: ','servide-finder');
				echo '</strong> ';
			...
			{
			echo '<div class="alert alert-info clear">'.esc_html__('Awaiting Identity verification','servide-finder').'</div>';
			}
			?>
          </div>
                </form>
