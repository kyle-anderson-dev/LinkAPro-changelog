...
$html = '<form class="clearfix search-providers" method="get" action="'.home_url('/').'">
  ...
  $html .= '<div class="'.$fieldclass.'">
    <div class="type-keyword">
      <input type="text" value="'.esc_attr($searchAddress).'" placeholder="'.esc_html__('Address', 'service-finder').'" id="searchAddress" name="searchAddress" class="form-control sf-form-control">
	  '.$autolocation.'
    </div>
  </div>';
  }
  ...
  $html .= '<div class="'.$fieldclass.'">
    <div class="category-select">
      <select id="categorysrh" name="catid" class="form-control sf-form-control sf-select-box" title="'.esc_html__('Category', 'service-finder').'" data-live-search="true" data-header="'.esc_html__('Select a Category', 'service-finder').'">
        <option value="">
