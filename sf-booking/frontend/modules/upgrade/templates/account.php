...
<input type="text" class="form-control sf-form-control" name="featuredays" id="featuredays" value="<?php echo (!empty($service_finder_options['feature-min-max-days'][1])) ? esc_attr($service_finder_options['feature-min-max-days'][1]) : '' ?>" >
