...
?>
    ...
    <div class="container">
        ...
        <div class="col-md-8">  
			...
			{
			?>
            <div class="sf-vender-parts-area bg-gray padding-30 clearfix" style="border-radius:5px;">
                <div class="section-content">
			...
			?>
			<div class="sf-vender-parts-area clearfix book-now-scroll" id="book-now-section">
                <div class="section-head text-center">
        ...
        <div class="col-md-4">
            ...
            <div class="sf-sidebar-right margin-t-30">
                ...
                <div class="sf-user-login padding-30 bdr-1-gray margin-b-30">
                    <div class="section-head text-center">
                        <h3><?php echo esc_html__('User Login', 'service-finder'); ?></h3>
                    </div>
                
                    <div class="form-login-bx">
                        <form class="loginform" method="post">
                            <div class="form-group">
                                <input name="login_user_name" type="text" class="form-control" placeholder="<?php esc_html_e('User Name', 'service-finder'); ?>">
                            </div>
                            <div class="form-group">
                                <input name="login_password" type="text" class="form-control" placeholder="<?php esc_html_e('Password', 'service-finder'); ?>">
                            </div>
                            
                            <div class="form-group">
                                <div class="checkbox sf-radio-checkbox">
                                  <input id="remember-me" type="checkbox" name="rememberme" value="yes">
                                  <label for="remember-me"><?php esc_html_e('Remember me', 'service-finder'); ?></label>
                                </div>
                            </div>
                            <div>
                                <input type="submit" value="<?php esc_html_e('Log in', 'service-finder'); ?>" class="btn btn-primary btn-block">
                            </div>
                        </form>
                    </div>
                ...
                <?php if(service_finder_get_data($service_finder_options,'request-quote') && service_finder_request_quote_for_loggedin_user()){ ?>
                <div class="sf-request-quote padding-30 margin-b-30 bg-gray" >
                    <div class="section-head text-center">
                        <h3><?php echo service_finder_get_data($service_finder_options,'requestquote-replace-string',esc_html__('Request a Quote', 'service-finder')); ?></h3>
                    </div>
                ...
                <?php
                $relatedproviders = service_finder_getRelatedProviders($providerInfo->wp_user_id,get_user_meta($providerInfo->wp_user_id,'primary_category',true),3);
				if(!empty($relatedproviders))
				{
				?>
                <div class="sf-related-provider padding-30 bdr-1-gray margin-b-30">
                    <div class="section-head text-center">
                        <h3><?php echo service_finder_get_data($service_finder_options,'label-related-provider',esc_html__('Related Providers', 'service-finder')); ?></h3>
                    </div>
                    <div class="sf-related-provider-bx margin-b-30">
                        <ul>
                            <?php
                            foreach($relatedproviders as $provider)
							{
							$profileurl = service_finder_get_author_url($provider->wp_user_id);
							...
							<li>
                                ...
                                <div class="post-thum-bx">
                                    <img src="<?php echo esc_url($src); ?>" width="150" height="150" alt="">
                                </div>
                                <div class="post-text-bx">
                                    <h4 class="post-title"><?php echo $provider->full_name; ?></h4>
                                    <?php if(service_finder_get_data($service_finder_options,'show-address-info') && service_finder_check_address_info_access()){ ?>
                                    <p><?php echo service_finder_getshortAddress($provider->wp_user_id); ?></p>
                                    <?php } ?>
                                </div>
                                </a>
                            </li>
