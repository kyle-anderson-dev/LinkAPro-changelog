	  ...
	  jQuery.ajax({
						...
						success:function (data, textStatus) {
							...
							if(data['status'] == 'success'){
								...
								jQuery("#service_finder_options-default-city").html('<select id="default-city-select form-control sf-form-control sf-select-box" class="redux-select-item " rows="6" style="width: 40%;" name="service_finder_options[default-city]" data-placeholder="Select an item" tabindex="-1" title="">'+data['html']+'</select>');
